...
namespace ZebraParser.Parser.Commands
{
    public partial class ZPLCommands
    {
        ...
        /// <summary>
        ///     Write any windows-supported text in any windows-supported font style to the printer - including international
        ///     characters!
        ///     Note that if your printer's RAM drive letter is something other than 'E', you must set it in printer settings
        ///     before calling ZPLCommands.ClearPrinter!
        /// </summary>
