...
namespace ZebraParser.Parser.Commands
{
    public partial class EPLCommands
    {
        ...
        public static byte[] CustomFontDelete(ZebraFont name)
        {
            ...
            return Encoding.GetEncoding(437).GetBytes("EK\"" + (char)name + "\"\n");
        }
        ...
        public static byte[] CustomFontStore(Font font, ZebraFont name, ElementUploadRotation rotation, FontCharsetType charset)
        {
            ...
            byte[] init =
            {
                (byte)10, (byte)'N', (byte)10, (byte)'E', (byte)'K', (byte)'"', (byte)name, (byte)'"', (byte)10,
            ...
            {
                //Use OEM encoding.  
                currentChr = Encoding.GetEncoding(437).GetBytes(FontCharset.CharList[(int)charset])[i];
